...
export class StoreService {
  ...
  updateAscensions() {
    ...
    if (this.characterService.bloodlineRank === 0) {
      ...
      // Home
      this.bloodlineDescription =
        'End your current life, sacrifice all attributes and aptitudes that are not protected by the power of your previous soul core ascensions, and enhance your bloodline. You will keep your weapons, armor, and money with interest, as well as crafting materials in your workstations.';
