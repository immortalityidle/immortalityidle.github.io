...
export class GameStateService {
  ...
  private getInventoryProperties(props: InventoryProperties | undefined): InventoryProperties {
    return {
      ...
      autoEatNutrition: props?.autoEatNutrition || false,
      ...
      autoBuyFood: props?.autoBuyFood || false,
  ...
  private getActivitiesProperties(props: ActivityProperties | undefined): ActivityProperties {
    return {
      ...
      pauseOnDeath: props?.pauseOnDeath || false,
    ...
    return {
      ...
      status: {
        ...
        qi: {
          ...
          value: props?.status.qi.value || 100,
          max: props?.status.qi.max || 100,
        ...
        nutrition: {
          ...
          value: props?.status.nutrition.value || 100,
          max: props?.status.nutrition.max || 100,
      ...
      age: props?.age || 0,
      baseLifespan: props?.baseLifespan || 0,
      ...
      attributeScalingLimit: props?.attributeScalingLimit || 0,
      attributeSoftCap: props?.attributeSoftCap || 0,
      aptitudeGainDivider: props?.aptitudeGainDivider || 0,
      condenseSoulCoreCost: props?.condenseSoulCoreCost || 0,
      reinforceMeridiansCost: props?.reinforceMeridiansCost || 0,
      bloodlineRank: props?.bloodlineRank || 0,
      qiUnlocked: props?.qiUnlocked || false,
      totalLives: props?.totalLives || 0,
      ...
      empowermentFactor: props?.empowermentFactor || 0,
      ...
      showLifeSummary: props?.showLifeSummary || false,
      showTips: props?.showTips || false,
      showUpdateAnimations: props?.showUpdateAnimations || false,
