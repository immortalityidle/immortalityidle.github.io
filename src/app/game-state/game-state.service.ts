...
export class GameStateService {
  ...
  private validateGameState(gameState: Partial<GameState>): GameState {
    const returnValue = {
      ...
      saveInterval: gameState.saveInterval || 0,
  ...
  private getActivitiesProperties(props: ActivityProperties | undefined): ActivityProperties {
    return {
      ...
      pillMoldCounter: props?.pillMoldCounter || 0,
      pillBoxCounter: props?.pillBoxCounter || 0,
      pillPouchCounter: props?.pillPouchCounter || 0,
  ...
  private getBattlesProperties(props: BattleProperties | undefined): BattleProperties {
    return {
      ...
      yearlyMonsterDay: props?.yearlyMonsterDay || 0,
      extraMonsterCounter: props?.extraMonsterCounter || 0,
  ...
  private getFollowersProperties(props: FollowersProperties | undefined): FollowersProperties {
    return {
      ...
      savedFollowerAssignments: props?.savedFollowerAssignments || [],
      savedPetAssignments: props?.savedPetAssignments || [],
      followerTriggers: props?.followerTriggers || [],
      petTriggers: props?.petTriggers || [],
      followerTriggerIndex: props?.followerTriggerIndex || 0,
      petTriggerIndex: props?.petTriggerIndex || 0,
  ...
  private getCharacterProperties(props: CharacterProperties | undefined): CharacterProperties {
    return {
      attributes: {
        ...
        wisdom: {
          value: props?.attributes?.wisdom?.value || 0,
          lifeStartValue: props?.attributes?.wisdom?.lifeStartValue || 0,
          aptitude: props?.attributes?.wisdom?.aptitude || 1,
          aptitudeMult: props?.attributes?.wisdom?.aptitudeMult || 1,
        },
        justice: {
          value: props?.attributes?.justice?.value || 0,
          lifeStartValue: props?.attributes?.justice?.lifeStartValue || 0,
          aptitude: props?.attributes?.justice?.aptitude || 1,
          aptitudeMult: props?.attributes?.justice?.aptitudeMult || 1,
        },
        mercy: {
          value: props?.attributes?.mercy?.value || 0,
          lifeStartValue: props?.attributes?.mercy?.lifeStartValue || 0,
          aptitude: props?.attributes?.mercy?.aptitude || 1,
          aptitudeMult: props?.attributes?.mercy?.aptitudeMult || 1,
        },
        wrath: {
          value: props?.attributes?.wrath?.value || 0,
          lifeStartValue: props?.attributes?.wrath?.lifeStartValue || 0,
          aptitude: props?.attributes?.wrath?.aptitude || 1,
          aptitudeMult: props?.attributes?.wrath?.aptitudeMult || 1,
        },
        presence: {
          value: props?.attributes?.presence?.value || 0,
          lifeStartValue: props?.attributes?.presence?.lifeStartValue || 0,
          aptitude: props?.attributes?.presence?.aptitude || 1,
          aptitudeMult: props?.attributes?.presence?.aptitudeMult || 1,
        },
        earthLore: {
      ...
      empowermentPillsTaken: props?.empowermentPillsTaken || 0,
  ...
  checkAvatarProgress() {
    ...
    if (this.avatarChallenge === AVATAR_BLOODTHIRSTY_BRAWLER) {
      ...
      const targetAttributeValue = 2e17;
