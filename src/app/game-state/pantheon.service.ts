  ...
  pantheons: Pantheon[] = [
    {
      ...
      gods: [
        ...
        },
        {
          ...
          unlockProgressRequired: signal<number>(100),
          unlockProgressPercent: signal<number>(0),
          baseDamage: this.greekBaseDamage * Math.pow(this.greekScaling, 5.6),
          baseDefense: this.greekBaseDefense * Math.pow(this.greekScaling, 5.6),
          baseHealth: this.greekBaseHealth * Math.pow(this.greekScaling, 5.6),
        ...
        },
        {
          ...
          baseDamage: this.greekBaseDamage * Math.pow(this.greekScaling, 6.2) * 2,
          baseDefense: this.greekBaseDefense * Math.pow(this.greekScaling, 6.2),
          baseHealth: this.greekBaseHealth * Math.pow(this.greekScaling, 6.2),
        ...
        },
        {
          ...
          unlockProgressRequired: signal<number>(100),
          unlockProgressPercent: signal<number>(0),
          baseDamage: this.greekBaseDamage * Math.pow(this.greekScaling, 6.8),
          baseDefense: this.greekBaseDefense * Math.pow(this.greekScaling, 6.8) * 2,
          baseHealth: this.greekBaseHealth * Math.pow(this.greekScaling, 6.8),
