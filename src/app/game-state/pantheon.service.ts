  ...
  pantheons: Pantheon[] = [
    {
      ...
      gods: [
        ...
        },
        {
          ...
          unlockProgressRequired: signal<number>(100),
          unlockProgressPercent: signal<number>(0),
          baseDamage: this.greekBaseDamage * Math.pow(this.greekScaling, 5.7),
          baseDefense: this.greekBaseDefense * Math.pow(this.greekScaling, 5.7),
          baseHealth: this.greekBaseHealth * Math.pow(this.greekScaling, 5.7),
        ...
        },
        {
          ...
          baseDamage: this.greekBaseDamage * Math.pow(this.greekScaling, 6.4) * 2,
          baseDefense: this.greekBaseDefense * Math.pow(this.greekScaling, 6.4),
          baseHealth: this.greekBaseHealth * Math.pow(this.greekScaling, 6.4),
        ...
        },
        {
          ...
          baseDefense: this.greekBaseDefense * Math.pow(this.greekScaling, 7) * 2,
