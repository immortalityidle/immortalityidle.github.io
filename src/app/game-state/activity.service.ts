      ...
      consequence: [
        () => {
          ...
          if (
            ...
            this.logService.addLogMessage(
              'You lack the necessary knowledge and cause a deadly explosion.',
              'INJURY',
              'EVENT'
            );
            this.characterService.characterState.status.health.value -=
            ...
            this.logService.addLogMessage(
              'You fumble with the wrong tools and materials and hurt yourself.',
              'INJURY',
              'EVENT'
            );
            this.characterService.characterState.status.health.value -=
      ...
      consequence: [
        () => {
          ...
          if (woodValue >= 11) {
            ...
            this.logService.addLogMessage(
              'You made ' + this.itemRepoService.items['scaffolding'].name,
              'STANDARD',
              'CRAFTING'
            );
          } else {
      ...
      consequence: [
        () => {
          ...
          if (
            ...
            this.logService.addLogMessage(
              "You try to research, but you just don't have the energy.",
              'STANDARD',
              'EVENT'
            );
            return;
      ...
      consequence: [
        () => {
          ...
          if (this.impossibleTaskService.taskProgress[ImpossibleTaskType.BefriendDragon].complete) {
            this.logService.addLogMessage(
              'You did the impossible and made friends with a dragon!',
              'STANDARD',
              'STORY'
            );
          }
