...
export class ActivityService {
  ...
  defineActivities(){
    ...
    this.OddJobs = {
      ...
      consequence: [() => {
        this.characterState.characterService.increaseAttribute("strength", 0.02);
        this.characterState.characterService.increaseAttribute('toughness', 0.02);
        this.characterState.characterService.increaseAttribute('speed', 0.02);
        this.characterState.characterService.increaseAttribute('intelligence', 0.02);
        this.characterState.characterService.increaseAttribute('charisma', 0.02);
