...
export class HomeService {
  ...
  homesList: Home[] = [
    {
      ...
      staminaRecovery: 0,
      qiRecovery: 0,
      baseHealthRecovery: 0,
      baseStaminaRecovery: 0,
      baseQiRecovery: 0,
      maxFurniture: 0,
      maxWorkstations: 0,
    ...
    },
    {
      ...
      description: 'A decent tent pitched on your own bit of land. The occasional ruffian might give you trouble.',
      cost: 100,
      costPerDay: 1,
      landRequired: 1,
      maxInventory: 15,
    ...
    },
    {
      ...
      staminaRecovery: 5,
      qiRecovery: 0,
      baseHealthRecovery: 0.7,
      baseStaminaRecovery: 5,
      baseQiRecovery: 0,
      maxFurniture: 2,
      maxWorkstations: 0,
      maxWorkstationPower: 0,
    ...
    },
    {
      ...
      staminaRecovery: 10,
      qiRecovery: 0.1,
      baseHealthRecovery: 1,
      baseStaminaRecovery: 10,
      baseQiRecovery: 0.1,
      maxFurniture: 3,
      maxWorkstations: 1,
      maxWorkstationPower: 0,
    ...
    },
    {
      ...
      description: 'A large house where you can live and work.',
      cost: 1000000,
      costPerDay: 50,
      landRequired: 50,
      maxInventory: 35,
    ...
    },
    {
      ...
      description: 'A large house with a wall and an enclosed courtyard. Perfect for building a thriving business.',
      cost: 1e7,
      costPerDay: 80,
      landRequired: 80,
      maxInventory: 40,
    ...
    },
    {
      name: 'Manor',
      type: HomeType.Manor,
      description: 'A large manor house. You are really moving up in the world.',
      cost: 1e8,
      costPerDay: 100,
      landRequired: 100,
      maxInventory: 50,
      ...
      staminaRecovery: 25,
      qiRecovery: 0.4,
      baseHealthRecovery: 4,
      baseStaminaRecovery: 25,
      baseQiRecovery: 0.4,
      maxFurniture: 6,
      maxWorkstations: 3,
      maxWorkstationPower: 0,
    ...
    },
    {
      ...
      description: 'An elaborate mansion.',
      cost: 1e9,
      costPerDay: 120,
      landRequired: 120,
      maxInventory: 50,
    ...
    },
    {
      ...
      staminaRecovery: 40,
      qiRecovery: 2,
      baseHealthRecovery: 15,
      baseStaminaRecovery: 40,
      baseQiRecovery: 2,
      maxFurniture: 9,
      maxWorkstations: 5,
      maxWorkstationPower: 1,
    ...
    },
    {
      ...
      description: 'An indomitable fortress.',
      cost: 1e12,
      costPerDay: 180,
      landRequired: 180,
      maxInventory: 65,
      ...
      staminaRecovery: 50,
      qiRecovery: 3,
      baseHealthRecovery: 20,
      baseStaminaRecovery: 50,
      baseQiRecovery: 3,
      maxFurniture: 9,
      maxWorkstations: 5,
      maxWorkstationPower: 1,
    ...
    },
    {
      ...
      description: 'An entire mighty mountain.',
      cost: 1e13,
      costPerDay: 500,
      landRequired: 500,
      maxInventory: 70,
      ...
      staminaRecovery: 100,
      qiRecovery: 4,
      baseHealthRecovery: 30,
      baseStaminaRecovery: 100,
      baseQiRecovery: 4,
      maxFurniture: 9,
      maxWorkstations: 6,
    ...
    },
    {
      ...
      description: 'A city of your very own.',
      cost: 1e14,
      costPerDay: 1000,
      landRequired: 1000,
      maxInventory: 80,
      ...
      staminaRecovery: 200,
      qiRecovery: 5,
      baseHealthRecovery: 50,
      baseStaminaRecovery: 200,
      baseQiRecovery: 5,
      maxFurniture: 9,
      maxWorkstations: 6,
      maxWorkstationPower: 2,
    ...
    },
    {
      ...
      description: 'The entire province is yours now.',
      cost: 1e15,
      costPerDay: 10000,
      landRequired: 10000,
      maxInventory: 100,
      ...
      staminaRecovery: 300,
      qiRecovery: 10,
      baseHealthRecovery: 80,
      baseStaminaRecovery: 300,
      baseQiRecovery: 10,
      maxFurniture: 9,
      maxWorkstations: 7,
      maxWorkstationPower: 2,
    ...
    },
    {
      ...
      description: "You've built quite a little empire for yourself.",
      cost: 1e16,
      costPerDay: 1e6,
      landRequired: 1e6,
      maxInventory: 110,
      ...
      staminaRecovery: 500,
      qiRecovery: 20,
      baseHealthRecovery: 100,
      baseStaminaRecovery: 500,
      baseQiRecovery: 20,
      maxFurniture: 9,
      maxWorkstations: 8,
    ...
    },
    {
      ...
      description: 'All in the land kneel far beneath you.',
      cost: 1e17,
      costPerDay: 1e7,
      landRequired: 1e7,
      maxInventory: 120,
      ...
      qiRecovery: 30,
      baseHealthRecovery: 150,
      baseStaminaRecovery: 1000,
      baseQiRecovery: 30,
      maxFurniture: 9,
      maxWorkstations: 9,
      maxWorkstationPower: 3,
  ...
  constructor(
    ...
    mainLoopService.longTickSubject.subscribe(() => {
      ...
      const concepts = this.contemplationService.concepts.filter(concept =>
        concept.effect.includes(CONCEPT_EFFECT_HOME_RECOVERY)
      );
      for (const concept of concepts) {
        conceptMultiplier *= Math.log10(10 + concept.progress);
      }
      this.home.healthRecovery = this.home.baseHealthRecovery * conceptMultiplier;
      this.home.staminaRecovery = this.home.baseStaminaRecovery * conceptMultiplier;
      if (this.characterService.qiUnlocked) {
        this.home.qiRecovery = this.home.baseQiRecovery * conceptMultiplier;
      } else {
  ...
  alchemistsWork(workAmount: number) {
    ...
    for (const cauldron of cauldrons) {
      this.craftAlchemy(cauldron, ActivityType.Alchemy, workAmount);
    }
  }
  ...
  craftAlchemy(workstation: Workstation, activityType: ActivityType, quantity: number = 1) {
    if (workstation.inputs.length < 1) {
      // inputs array not populated, bail out
      return;
    }
    ...
    if (workstation.alchemyProduct === 'attribute pills') {
      ...
      const crafts = Math.floor(workstation.productCounter / (this.pillCraftsRequired * 10));
      ...
      if (divineFruitStack?.item?.id === 'divinePeach') {
        const outputQuantity = Math.min(Math.floor(divineFruitStack.quantity / 10), quantity);
        divineFruitStack.quantity -= 10 * outputQuantity;
        this.inventoryService.addItem(this.itemRepoService.items['distilledPeachEssence'], outputQuantity);
      } else if (divineFruitStack?.item?.id === 'grapes' && divineFruitStack.quantity > 10000) {
        const outputQuantity = Math.min(Math.floor(divineFruitStack.quantity / 10000), quantity);
        divineFruitStack.quantity -= 10000 * outputQuantity;
        this.inventoryService.addItem(this.itemRepoService.items['wine'], outputQuantity);
      }
      const coalStack = workstation.inputs.find(
        itemStack => itemStack.item?.type === 'coal' && itemStack.quantity >= 100
      );
      if (coalStack) {
        const outputQuantity = Math.min(Math.floor(coalStack.quantity / 100), quantity);
        coalStack.quantity -= 100 * outputQuantity;
        this.inventoryService.addItem(this.itemRepoService.items['coke'], outputQuantity);
      }
      if (this.nectarUnlocked) {
        ...
        if (wineStack) {
          const outputQuantity = Math.min(Math.floor(wineStack.quantity / 1000), quantity);
          wineStack.quantity -= 1000 * outputQuantity;
          this.inventoryService.addItem(this.itemRepoService.items['nectar'], outputQuantity);
        }
      }
      ...
      if (dreadsteelStack) {
        const outputQuantity = Math.min(Math.floor(dreadsteelStack.quantity / 100), quantity);
        dreadsteelStack.quantity -= 100 * outputQuantity;
        this.inventoryService.addItem(this.itemRepoService.items['refinedDreadsteelBar'], outputQuantity, 0, true);
      }
    } else {
