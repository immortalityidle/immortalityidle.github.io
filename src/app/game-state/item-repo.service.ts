...
export const ITEM_TYPE_REFINED_METAL = 'refined metal';
export const ITEM_TYPE_METAL = 'metal';
...
*/
  ...
  items: { [key: string]: Item } = {
    ...
    grapes: {
      ...
      subtype: 'divinefruit',
      value: 300,
      description: 'A strange cluster of foreign fruit.',
      useLabel: 'Eat',
      useDescription: 'Fills your belly, but might be more useful for something other than eating.',
      useConsumes: true,
      shopable: true,
    },
    divinePeach: {
      ...
      value: 1000,
      description:
        'A divinely prized and delicious fruit. It might even have alchemical applications if properly distilled.',
      useLabel: 'Eat',
    ...
    distilledPeachEssence: {
      ...
      value: 5000,
      description:
        'An alchemical masterpiece created from the most perfect of peaches. Can increase the power of pills and potions.',
      effect: 'health',
      shopable: true,
    },
    wine: {
      ...
      attribute: 'any',
      value: 6000,
      description: 'A strange foreign drink made from fermented grapes.',
      effect: 'health',
      shopable: true,
    },
    nectar: {
    ...
    rottenWoodScraps: {
      ...
      imageFile: 'wood',
      imageColor: this.colorByRank[0],
      name: 'rotten wood scraps',
      type: 'wood',
      subtype: 'fuel',
      value: 1,
      description: 'It kind of looks like it might have been part of a log once. Maybe.',
      shopable: false,
    },
    balsaLog: {
      id: 'balsaLog',
    ...
    dreamwoodLog: {
      ...
      subtype: 'fuel',
      value: 8000,
      description: 'A quality of lumber that only gods could dream of.',
      shopable: false,
    },
    coal: {
      id: 'coal',
    ...
    dreadsteelBar: {
      ...
      type: ITEM_TYPE_METAL,
      value: 80000,
      description: 'A bar of dreadsteel. Its blackness is so absolute no light can escape it.',
      shopable: false,
    },
    refinedDreadsteelBar: {
      ...
      type: ITEM_TYPE_REFINED_METAL,
      value: 800000,
      description: 'A bar of refined dreadsteel. Its strength and durability are almost unimaginable.',
      shopable: false,
    },
    junk: {
      id: 'junk',
    ...
    divineChain: {
      ...
      type: 'chain',
      value: 1,
      description: 'This chain is specially forged to be unimaginably strong and light.',
      shopable: false,
    },
    everlastingBrick: {
      id: 'everlastingBrick',
    ...
    portalKey: {
      ...
      use: () => {
        ...
        this.characterService.seclusionEnabled.set(true);
    ...
    hellCrownTongueRippers: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.TongueRipping)) {
    ...
    hellCrownScissors: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.Scissors)) {
    ...
    hellCrownTreesOfKnives: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.TreesOfKnives)) {
    ...
    hellCrownPillars: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.CopperPillars)) {
    ...
    hellCrownMountainOfKnives: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.MountainOfKnives)) {
    ...
    hellCrownMountainOfIce: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.MountainOfIce)) {
    ...
    hellCrownCauldronsOfOil: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.CauldronsOfOil)) {
    ...
    hellCrownCattlePit: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.CattlePit)) {
    ...
    hellCrownCrushingBoulder: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.CrushingBoulder)) {
    ...
    hellCrownMortarsAndPestles: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.MortarsAndPestles)) {
    ...
    hellCrownBloodPool: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.BloodPool)) {
    ...
    hellCrownWrongfulDead: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.WrongfulDead)) {
    ...
    hellCrownDismemberment: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.Dismemberment)) {
    ...
    hellCrownFireMountain: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.MountainOfFire)) {
    ...
    hellCrownMills: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.Mills)) {
    ...
    hellCrownSaws: {
      ...
      use: () => {
        ...
        if (!this.hellService.completedHellBosses.includes(LocationType.Saws)) {
